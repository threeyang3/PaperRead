...
| Automated regression | Pass | All 115 tests in the authoritative repository `tests/` tree and both Node plugin suites (2/2) pass. Coverage includes four unique reading leaves, PDF focus, PDF++ selection success/fallback, canonical annotation indexing, CLI allowlisting, modal UI, Workspace v3 repair, rollback, Community tamper rejection, Feed privacy, lifecycle, and scheduling. |
