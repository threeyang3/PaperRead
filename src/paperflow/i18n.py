...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh-CN": {
        ...
        "property.paper_title_display": "显示标题",
        "property.ai_topic_links": "主题双链",
        "property.ai_method_links": "方法双链",
        "property.ai_dataset_links": "数据集双链",
        "property.paper_cites": "已验证引用",
        "property.paper_citation_ids": "外部引用标识",
        "property.ai_related_papers": "语义相关论文",
    ...
    "en": {
        ...
        "property.paper_title_display": "Display title",
        "property.ai_topic_links": "Topic links",
        "property.ai_method_links": "Method links",
        "property.ai_dataset_links": "Dataset links",
        "property.paper_cites": "Verified citations",
        "property.paper_citation_ids": "External citation IDs",
        "property.ai_related_papers": "Semantically related papers",
